...
productsRouter.use( productsMiddleware.extendReqNewProduct, productsMiddleware.extendObjectWithLastModifiedData, productsMiddleware.isExistId, productsMiddleware.errorHandler);
